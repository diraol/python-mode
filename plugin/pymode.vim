...
if g:pymode_rope
    ...
    call pymode#default('g:pymode_rope_rename_module_bind', '<leader>rrm')

    " Bind keys for convert module to package
    call pymode#default('g:pymode_rope_module_to_package_bind', '<leader>rmp')

    " Creates a new function or method (depending on the context) from the selected lines
    call pymode#default('g:pymode_rope_extract_method_bind', '<leader>rem')

    " Creates a variable from the selected lines
    call pymode#default('g:pymode_rope_extract_variable_bind', '<leader>rev')

    " Inline refactoring
    call pymode#default('g:pymode_rope_inline_bind', '<leader>ri')

    " Move refactoring
    call pymode#default('g:pymode_rope_move_bind', '<leader>rmv')
